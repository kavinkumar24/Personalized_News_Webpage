...
</div><h1 id="h1">General News</h1>
<div class="input-group" id='search_bar'>
  <input type="search" class="form-control rounded" placeholder="Search" onChange={event=>{setSearch(event.target.value)}} aria-label="Search"  />
  <button type="button" class="btn btn search" id="search">search</button><Link to="newspaper"><button>Newspaper</button></Link>
</div>
